...
-- Eclipse PDE support
vim.list_extend(bundles,
	vim.split(vim.fn.glob(vim.env.HOME .. '/.local/eclipse-pde/extension/server/*.jar', true), "\n"))
...
local config = {
	...
	cmd = {
		...
		'-Dlog.protocol=true',
		'-Dlog.level=ALL',
		'-javaagent:' .. vim.env.HOME .. '/.local/share/nvim/mason/share/lombok-nightly/lombok.jar',
		'-Xmx4g',
